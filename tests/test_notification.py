...
"""
        ...
        self.assertIn("🇨🇳 A股：整体偏弱", summary)
        self.assertIn("🇭🇰 港股：整体偏强", summary)
        self.assertIn("🇺🇸 美股：整体偏弱", summary)
        self.assertIn("🇯🇵 日股：整体偏强", summary)
        self.assertIn("🇰🇷 韩股：整体震荡", summary)
        self.assertNotIn("点位：", summary)
...
"""
        ...
        self.assertIn("🇭🇰 港股：整体偏弱", summary)
        self.assertIn("🇺🇸 美股：数据暂缺", summary)
        self.assertIn("🇯🇵 日股：数据暂缺", summary)
        self.assertIn("🇰🇷 韩股：数据暂缺", summary)
...
"""
        ...
        self.assertIn("• 领涨方向：半导体", summary)
        self.assertIn("• 领跌方向：煤炭", summary)
        self.assertIn("• 领涨个股 Top 3：芯片A / 算力B", summary)
        self.assertIn("• 领跌个股 Top 3：煤炭A", summary)
        self.assertNotRegex(summary, r"^\|", msg="Discord summary should not contain Markdown table rows")
