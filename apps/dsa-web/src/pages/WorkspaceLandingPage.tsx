...
const TEXT = {
  zh: {
    ...
    funds: '基金中心', fundDescription: '基金自选、基金持仓、问基金、基金对比、行业穿透、行业周期和风险建议。',
    enter: '进入', manageUsers: '管理用户', boundaryTitle: '当前基金能力边界',
    boundary: '公开基金资料、净值、披露持仓、基金对比、行业穿透及可解释周期/经营生产力代理证据已接入；配置建议和 AI 仍未接入，不生成虚假结果。',
  },
  en: {
    ...
    funds: 'Fund center', fundDescription: 'Fund watchlists, holdings, Q&A, comparisons, industry exposure, cycles, and risk guidance.',
    enter: 'Open', manageUsers: 'Manage users', boundaryTitle: 'Current fund capability boundary',
    boundary: 'Public profiles, NAV, disclosed holdings, comparison, industry exposure, and explainable cycle/operating-productivity proxy evidence are connected. Allocation advice and AI remain unavailable and are never fabricated.',
  },
} as const;
