...
const TEXT = {
  zh: {
    ...
    manageUsers: '管理用户',
    addHolding: '添加持仓',
    screenshotRecognition: '截图识别',
    userNotConnectedTitle: '该用户尚未接入正式持仓数据',
    userNotConnectedDescription: '可先使用快速录入添加基金和股票；正式行情、截图识别和长期保存将在后续阶段接入。',
  ...
  en: {
    ...
    screenshotRecognition: 'Screenshot import',
    userNotConnectedTitle: 'Formal holdings are not connected for this user',
    userNotConnectedDescription: 'Use quick entry first. Formal quotes, screenshot recognition, and persistence will follow.',
