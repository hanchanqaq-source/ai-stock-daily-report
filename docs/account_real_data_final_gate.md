...
最终安全闸门复用个人使用场景文案策略：允许个人观察标签和资金看板类页面文案，允许股票 / ETF / 指数实时涨跌语义；场外基金仍不能写成实时涨跌或实时价格。文案放宽不改变 redacted payload、secret 扫描、真实金额 / 成本价 / 账户资产阻断和不自动下单边界。详见 `docs/personal_wording_policy.md`。
