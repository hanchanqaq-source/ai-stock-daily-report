...
| [Windows Portable-M2 更新规划](windows_portable_m2_update_plan.md) | 便携版更新的 SHA-256/结构复验、系统确认、程序文件恢复点、受控交接与失败回退边界 |
...
| [股票基金双中心 Build E8：问答会话分区](stock_fund_dual_center_build_e8.md) | 问答会话、列表与本机恢复键按当前用户和股票/基金领域隔离 |
