...
Web-P32 是“股票基金质量分析系统”的 mock 报告 schema 文档阶段，只描述 Web-P31 已统一的 mock-only 日报 fixture 结构与页面字段契约。Web-P34 在此基础上新增前端兼容映射层，将 mock 原始结构转换为页面稳定消费的展示模型。当前日报 / 推送显示名称固定为“AI股票基金每日信息报告”。
