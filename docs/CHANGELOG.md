...
- [新功能] 新增前端 mock-only preview entry 设计、non-runtime preview scaffold、草案页面和单元测试，演示后续 preview 如何消费 L2I mockService；本轮不接入真实 Web App、不修改 main.tsx / App.tsx / 路由 / apiClient、不新增启动脚本、不请求真实网络。
