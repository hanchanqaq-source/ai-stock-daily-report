...
后续基金、股票、ETF、企业、行业、主题、指数都统一使用 `asset` 对象表达。账户分组、个人雷达、持有 / 收藏管理、持有 vs 收藏对比和本地网页工作台都应复用同一套资产字段、枚举、校验、摘要和公开安全视图，避免为基金、股票或企业观察分别维护平行结构。持有 vs 收藏对比分析见 `docs/holding_watch_compare.md`。账户动态页面模型见 `docs/account_page_model.md`。
