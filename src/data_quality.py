...
def _assess_mapping(payload: Mapping[str, Any]) -> DataQualityResult:
    ...
    aliases = {
        ...
        "leading_industries": ("leading_industries", "industry_top", "industry_top3", "top_industries", "top_sectors"),
        "lagging_industries": ("lagging_industries", "industry_bottom", "industry_bottom3", "bottom_industries", "bottom_sectors"),
