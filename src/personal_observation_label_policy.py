...
ALLOWED_PERSONAL_OBSERVATION_LABELS = [
    "买入观察", "分批买入", "低吸区", "加仓观察", "继续持有", "等待回调", "减仓观察", "冲高减仓",
    "止盈观察", "止损观察", "清仓观察", "风险位", "目标区", "压力位", "支撑位", "暂不操作",
...
FORCED_TRADING_EXPRESSIONS = [
    "必须买入", "必须卖出", "必须加仓", "必须清仓", "立即买入", "立即卖出", "立即满仓", "马上满仓", "梭哈",
    "系统建议你买入", "系统建议你卖出",
]
GUARANTEED_RETURN_EXPRESSIONS = ["稳赚", "保证收益", "无风险", "一定涨", "一定翻倍"]
AUTO_EXECUTION_EXPRESSIONS = ["系统替你下单", "自动下单", "自动买入", "自动卖出", "代替用户操作"]
